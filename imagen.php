	...
	<div class="header">
		...
		<a href="https://twitter.com"><img src="images/twitter.ico" width="30" height="30"></a>
				...
				<div class="header_top">
					<div class="logo">
						<a href="index.php"><img src="images/logo.png" w /></a>
					</div>
  		    ...
  		    <div class="navigation">
    	    	...
    	    	<h3>Las mejores pantallas para tu comidad</h3>
	            <div class="section group">
                
                  <?php
				include "conexion.php";	
								
					$consultar = mysqli_query($conexion,"SELECT * FROM productos inner join catgoria on	Catgoria_idCatgoria = idCatgoria WHERE Categoria = 'Imagen'
					");
