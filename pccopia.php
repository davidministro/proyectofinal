...
<li  class="test">
    	    	...
    	    	<h3>COMPUTADORAS EN EXISTENCIA</h3>
	            <div class="section group">
				  <?php
				include "conexion.php";	
								
					$consultar = mysqli_query($conexion,"SELECT * FROM productos inner join catgoria on	Catgoria_idCatgoria = idCatgoria WHERE Categoria = 'Desktops'
					");
