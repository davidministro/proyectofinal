	...
	<div class="header">
		...
		<a href="https://twitter.com"><img src="images/twitter.ico" width="30" height="30"></a>
  		    ...
  		    <div class="navigation">
    	    	...
    	    	<h3>Los mejores accesorios 1. . .</h3>
				...
				include "conexion.php";	
					...
					$consultar = mysqli_query($conexion,"SELECT * FROM productos inner join catgoria on	Catgoria_idCatgoria = idCatgoria WHERE Categoria = 'Accessorio'
					");
